...
Neben Wissenschaften wie Physik, Chemie oder Biologie, nimmt Visualisierung auch besonders in der Informatik eine wichtige Rolle ein. In vielen Bereichen müssen Informationen in eine visuelle Form gebracht werden, die für einen menschlichen Betrachter leicht zu verstehen und interpretieren sind.
...
Angefangen bei UML-Diagramme waren die meisten Darstellungsformen der Softwarevisualisierung bislang meist zweidimensional. Mit AR wird dieser Disziplin der Visualisierung jedoch wortwörtlich ein neuer Raum an Möglichkeiten eröffnet und diese Arbeit soll damit beginnen, den Raum ausfüllen.
...
%RHU: Was genau soll die Referenz zu sec:requirements mitten im Text?
...
%RHU: US5 weißt wiederum Ähnlichkeiten zu US5 auf. Say whaat? Bitte fixen :)
...
\begin{tikzpicture}
  ...
  \umlclass[y=-5, x=-6]{Relation}{
    ...
    End \\
    Codesnippets \\
%RHU: Ich bin mir nicht sicher, aber sagt der Text unten drunter nicht, dass die Codesnippets an der Relation hängen?
  }{}
...
\label{fig:ui-model}
\end{figure}
%RHU: Zumindest in dem PDF, das ich gedruckt habe, war direkt unter dem Kasten für UiInnerNode das 0..* sichtbar und nicht wie erwartet oben bei der eigentlichen Verbindung???
...
%RHU: Die Bezeichnungen irgendwie konsistent halten. Im Zweifelsfall "Hi-Fi" und "Lo-Fi" - wichtig ist aber: KONSISTENT über die ganze Arbeit hinweg!
...
\begin{quotation}
  \textit{Der Nutzer kann einstellen, ob bei einem Klick auf ein Blatt der Klassenname oder der Wert der gerade visualisierten Metrik angezeigt wird.}
\end{quotation}

Das eigentliche Problem bei der beschriebenen Situation ist, dass Businesslogik und UI-Logik zu eng gekoppelt wurden. Diese Art enger Kopplung sollte tunlichst vermieden werden. Der Code in der UI-Schicht, der auf das tatsächliche Event reagiert, das durch den Nutzer ausgelöst wurde, sollte keine fachlichen Entscheidungen treffen, sondern dem Business-Kern der Anwendung lediglich eine entsprechende Nachricht zukommen lassen. Die Businesslogik hingegen sollte sich nicht mit der konkreten Event-Behandlung in der UI beschäftigen, sondern lediglich die Veränderung des System-Zustands im Verlauf der Zeit steuern. Dieser Zustand wiederum steht sozusagen für sich selbst. Die UI muss über Änderungen am Zustand in geeigneter Form benachrichtigt werden und sich selbst entsprechend aktualisieren.
...
%RHU: Ich würde die Dinger entweder auf Deutsch "Manipulationsindikatoren" oder gescheit auf englisch "manipulation indicators" nennen. Kein Mischmasch. Irgendwo habe ich auch mal "Manipulation-Indikators" gelesen, brrrrrr......
...
Das Kontextmenü für den Waldboden im High-Fi Prototypen ist in Abbildung \ref{fig:context-menu} zu sehen.
