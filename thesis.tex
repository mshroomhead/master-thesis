...
%----==== colors ====----%
\definecolor{primary}{HTML}{1E6A8B}
\definecolor{secondary}{HTML}{26A5C5}
\definecolor{tertiary}{HTML}{9EE8FE}
...
\newtcbtheorem[number within=chapter]{defboxfullwidth}{Definition}{
  basestyle,
  fonttitle=\sffamily\bfseries,
  description font=\mdseries,
  width=\textwidth
...
\newtcolorbox[auto counter]{userstory}[2][]{basestyle, valign=center, halign=left, after skip=0em, title=\textbf{Userstory \thetcbcounter:} #2, label=#1}
