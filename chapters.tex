...
Wie in Abschnitt \ref{sec:distinction} bereits festgehalten, soll der Schritt des Transfers der realen Software in deren abstrakte Repräsentation in dieser Arbeit nur am Rande betrachtet werden. Das Datenmodell ist hingegen sehr wohl zu definieren, um die Daten der nächsten Schicht zur Verfügung zu stellen.
