...
\begin{tabularx}{\textwidth}{cX}
    ...
    \accid{acc:s-metrics} & Ich kann statische Metriken der Code-Qualität, wie z.B. Code-Coverage, auf die Farbe der Blätter anwenden.\\
    \accid{acc:s-hotspots} & Ich kann Ausreißer der ausgewählten Metrik gut erkennen.\\
    \accid{acc:s-metric-value} & Ich kann mir die genaue Zahl der aktuellen Metrik für eine bestimmte Klasse anzeigen lassen\\
...
\begin{tabularx}{\textwidth}{cX}
	...
	\tableheader{2}{\textbf{ID} & \textbf{Beschreibung}}
    \accid{s-hotspots} & Die Struktur der Bäume entspricht der der Software.\\
    \accid{acc:s-structure} & Die Struktur der Bäume ist eindeutig und hat keine Überschneidungen.\\
    \accid{acc:s-leaf-connections} & Wenn ich ein Blatt auswähle, dann kann ich die ein- bzw. ausgehenden Abhängigkeiten hervorheben.\\
    \accid{acc:s-thickness} & Die Dicke einer Kante oder Wurzel zeigt mir die Anzahl der dazugehörigen Abhängigkeiten.\\
    \accid{acc:s-connection-highlight} & Wenn ich eine Kante oder Wurzel auswähle, dann kann ich die von den Abhängigkeiten betroffenen Blättern hervorheben.\\
    \accid{acc:s-connection-count} & Wenn ich eine Kante oder Wurzel auswähle, dann kann ich sehen wie viele Abhängigkeiten in welche Richtung fließen.\\
    \accid{acc:s-timestamp} & Ich kann den Zeitpunkt auswählen, auf die sich die dargestellten Daten beziehen.\\
    \accid{acc:s-cyclic} & Zyklische Verbindungen können hervorgehoben werden.\\
\end{tabularx}
...
\begin{tabularx}{\textwidth}{cX}
	...
	\tableheader{2}{\textbf{ID} & \textbf{Beschreibung}}
    \accid{acc:s-drilldown} & Wenn ich eine Kante auswähle, dann kann ich das repräsentierte Softwareartefakt als neuen Waldboden festlegen.\\
    \accid{acc:s-reset} & Ich habe die Möglichkeit den Wald zurückzusetzen.\\
\end{tabularx}
...
\begin{tabularx}{\textwidth}{cX}
	...
	\tableheader{2}{\textbf{ID} & \textbf{Beschreibung}}
    \accid{acc:d-metrics} & Ich kann Antwortzeiten und Laufzeitfehler auf die Blattfarbe anwenden.\\
    \accid{acc:d-hotspots} & Ich kann Ausreißer der ausgewählten Metrik gut erkennen.\\
    \accid{acc:d-metric-value} & Ich kann mir die genaue Zahl der aktuellen Metrik für eine bestimmte Klasse anzeigen lassen\\
    \accid{acc:d-leaf-connections} & Wenn ich ein Blatt auswähle, dann kann ich die ein- bzw. ausgehenden Aufrufe hervorheben.\\
    \accid{acc:d-thickness} & Die Dicke einer Kante oder Wurzel zeigt mir die Anzahl der dazugehörigen Aufrufe.\\
    \accid{acc:d-connection-highlight} & Wenn ich eine Kante oder Wurzel auswähle, dann kann ich die von den Aufrufen betroffenen Blättern hervorheben.\\
    \accid{acc:d-connection-count} & Wenn ich eine Wurzel oder Kante anklicke, dann kann ich sehen wie viele Verbindungen in welche Richtung gehen.\\
...
\begin{tabularx}{\textwidth}{cX}
    ...
    \accid{acc:d-no-intersections} & Die Struktur der Bäume ist möglichst übersichtlich und hat so wenig Überschneidungen wie möglich.\\
\end{tabularx}
...
\begin{tabularx}{\textwidth}{cX}
    ...
    \accid{acc:u-identify} & Ich kann Elemente im Wald mit dem Namen der repräsentieren Softwareartefakte identifizieren.\\
\end{tabularx}
